...
function FC_CompraSubProd(IDSubProd,Cor,Adicional1,Adicional2,Adicional3,AdicionalD1,AdicionalD2,AdicionalD3,IDProduto){
  ...
  if(Adicional1!='')sParamsProd+='&Adicional1_'+ IDSubProd +'='+ EncodeParamFC(Adicional1);
  if(Adicional2!='')sParamsProd+='&Adicional2_'+ IDSubProd +'='+ EncodeParamFC(Adicional2);
  if(Adicional3!='')sParamsProd+='&Adicional3_'+ IDSubProd +'='+ EncodeParamFC(Adicional3);
  if(AdicionalD1!='')sParamsProd+='&AdicionalD1_'+ IDSubProd +'='+ EncodeParamFC(AdicionalD1);
  if(AdicionalD2!='')sParamsProd+='&AdicionalD2_'+ IDSubProd +'='+ EncodeParamFC(AdicionalD2);
  if(AdicionalD3!='')sParamsProd+='&AdicionalD3_'+ IDSubProd +'='+ EncodeParamFC(AdicionalD3);
...
function FC_fInitProd(IDProduto){
  ...
  document.write("<div class='gradeComprar' style='position:relative' id=EstTabBotComprar><div class='gradeComprarDados' onClick='alertaEscolha();' id=alertaEsconde></div><span id=CorProduto></span><span id=GrauProduto></span><span id=CurvaProduto></span><span id=MarcaProduto></span><span id=Campo1></span><span id=Campo2></span><span id=Campo3></span><br><input type=button class=BotComprarGrid name=FC_oBotao_"+ IDProduto +" id=FC_oBotao_"+ IDProduto +" onClick='' value='' style='z-index:1;'><br><div id=alerta>ATEN&Ccedil;&Atilde;O: Selecione as op&ccedil;&otilde;es do produto acima.</div></div>");
