...
if(sPag.indexOf("CADASTRO.ASP")>=0){
  ...
  //banner do e-bit na página de confirmação do pedido
  try{document.getElementById("BannerEbitPC").style.display='none';}catch(e){}
...
//Página Forma de pagamento
  ...
  try{document.getElementById("TabParcelas3.1").style.width='60px';}catch(e){}
  try{document.getElementById("TabParcelas3.2").style.width='60px';}catch(e){}
  try{document.getElementById("TabParcelas3.3").style.width='60px';}catch(e){}
  try{document.getElementById("TabParcelas3.4").style.width='60px';}catch(e){}
  try{document.getElementById("TabParcelas3.5").style.width='60px';}catch(e){}
  try{document.getElementById("TabParcelas3.6").style.width='60px';}catch(e){}
  try{document.getElementById("TabParcelas3.7").style.width='60px';}catch(e){}
