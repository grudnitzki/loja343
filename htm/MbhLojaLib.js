...
function ShowCartOnPage(IDLoja,iErr,sMsg,sCartText,sCheckoutText,este){
  ...
  oDivShowCartOnPage.style.marginTop="-260px";
  oDivShowCartOnPage.style.marginLeft="-10px";
  ...
  var sHTML="<table width=250 height=141 border=0 cellpadding=3 cellspacing=3 class='fc-botfin'>";
     sHTML+="<tr>";
     sHTML+="<td colspan=5 align=center style='background-color:#"+ sBackColor +";color:#000000;font-size:9px;font-family:verdana;cursor:pointer;padding-left:30px;padding-top:35px; height: 36px'>"+ sMsg +"</td>";
     sHTML+="<td align=right><img src='"+FC$.PathImg+"cancel.png' hspace=5 style='cursor:pointer;margin-left:-25px;margin-top:-10px' onclick=oDivShowCartOnPage.style.visibility='hidden'></td>";
     sHTML+="</tr>";
     if(iErr==0){
       sHTML+="<tr>";
       sHTML+="<td width=3>&nbsp;</td>";
       sHTML+="<td align=center style=padding-bottom:25px;padding-left:10px><a onclick=oDivShowCartOnPage.style.visibility='hidden' style=color:#444444;text-decoration:none;font-size:12px;cursor:pointer;>CONTINUAR COMPRANDO</a></td>";
       sHTML+="<td width=3>&nbsp;</td>";
       sHTML+="<td align=center style=padding-bottom:25px;padding-left:10px><a href='addproduto.asp?idloja="+ IDLoja +"' style=color:#444444;text-decoration:none;font-size:12px;color:#00b900>FINALIZAR PEDIDO</a></td>";
       sHTML+="</tr>";
