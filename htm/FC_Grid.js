...
function FC_fInitProd(IDProduto){
  ...
  document.write("<div class='gradeComprar os_relativo' id=EstTabBotComprar><div class='gradeComprarDados' onClick='alertaEscolha();' id=alertaEsconde></div><span id=CorProduto></span><span id=GrauProduto></span><span id=CurvaProduto></span><span id=MarcaProduto></span><span id=Campo1></span><span id=Campo2></span><span id=Campo3></span><br><input type=button class=BotComprarGrid name=FC_oBotao_"+ IDProduto +" id=FC_oBotao_"+ IDProduto +" value='' style='z-index:1;cursor:pointer'><br><div id=alerta>ATEN&Ccedil;&Atilde;O: Selecione as op&ccedil;&otilde;es do produto acima.</div></div>");
